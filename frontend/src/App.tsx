...
function BootstrapLoader({ children }: { children: React.ReactNode }) {
  ...
  const setWorkspaceBootstrap = useShellStore((state) => state.setWorkspaceBootstrap)
  ...
  }, [checkAuth, hasCheckedAuth, isAuthenticated, isLoading, setRoutes, setWorkspaceBootstrap])

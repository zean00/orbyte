...
func TestUILeaveSelfServiceRoutesAreEmployeeScoped(t *testing.T) {
	h := newTestHarness(t)
	for _, permissionKey := range []string{"leave.self_service.read", "leave.self_service.write"} {
...
func registerLeaveSelfServiceTestModels(t *testing.T, models *model.Service) {
	...
	defs := []model.Definition{
		...
		{Key: "leave_request", DisplayName: "Leave Request", DefaultSort: "start_date", Fields: []model.FieldDefinition{{Key: "employee_id", Type: "string"}, {Key: "organization_id", Type: "string"}, {Key: "location_id", Type: "string"}, {Key: "absence_code_id", Type: "string"}, {Key: "leave_policy_id", Type: "string"}, {Key: "employee_leave_profile_id", Type: "string"}, {Key: "balance_account_id", Type: "string"}, {Key: "start_date", Type: "string"}, {Key: "end_date", Type: "string"}, {Key: "request_unit", Type: "string"}, {Key: "requested_days", Type: "number"}, {Key: "half_day_session", Type: "string"}, {Key: "request_source", Type: "string"}, {Key: "self_service_actor_user_id", Type: "string"}, {Key: "approval_status", Type: "string"}, {Key: "approved_days", Type: "number"}, {Key: "reservation_entry_ids_json", Type: "string"}, {Key: "consumption_entry_ids_json", Type: "string"}, {Key: "notes", Type: "string"}, {Key: "status", Type: "string"}}},
		...
		{Key: "leave_policy", DisplayName: "Leave Policy", DefaultSort: "code", Fields: []model.FieldDefinition{{Key: "code", Type: "string"}, {Key: "name", Type: "string"}, {Key: "absence_code_id", Type: "string"}, {Key: "paid_leave", Type: "bool"}, {Key: "requires_balance", Type: "bool"}, {Key: "allows_half_day", Type: "bool"}, {Key: "notice_days", Type: "number"}, {Key: "status", Type: "string"}}},

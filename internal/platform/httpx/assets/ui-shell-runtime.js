// Flow runtime, record editors, and shell bootstrap orchestration.
    ...
    async function renderNotificationsWorkspace(root) {
      ...
      root.innerHTML = '<section class="page-panel floorplan-worklist"><div class="page-header"><div><div class="page-eyebrow">Inbox</div><h3>' + escapeHTML(t('notifications')) + '</h3><p class="status">' + escapeHTML(t('notifications_status')) + '</p></div><div class="page-header-actions"><span class="badge subtle">items ' + escapeHTML(String(items.length)) + '</span></div></div><div class="page-body"><div class="table-shell"><table class="data-table"><thead><tr><th>Message</th><th>Status</th><th>Created</th><th></th></tr></thead><tbody>' + (items.map(function (item) {

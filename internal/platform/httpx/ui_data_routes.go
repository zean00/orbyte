...
func registerUIDataRoutes(mux *http.ServeMux, ident *identity.Service, modules *module.Service, models *model.Service, activities *activity.Service, reportingSvc *reporting.Service, docs *document.Service, workflowSvc *workflow.Service, searchSvc *search.Service, analyticsSvc *analytics.Service, monitoringSvc *monitoring.Service, commercialSvc *application.CommercialCoreService, procurementSvc *application.ProcurementCoreService, crmSvc *application.CRMCoreService, inventorySvc *application.InventoryCoreService, fulfillmentSvc *application.FulfillmentCoreService, planningSvc *application.PlanningCoreService, productionSvc *application.ProductionCoreService, posSvc *application.POSCoreService, traceabilitySvc *application.TraceabilityCoreService, recallSvc *application.RecallCoreService, financeSvc *application.FinanceReportingCoreService, reconciliationSvc *application.FinanceReconciliationCoreService, periodEndSvc *application.FinancePeriodEndCoreService, manualJournalSvc *application.FinanceManualJournalCoreService, collectionsSvc *application.FinanceCollectionsCoreService, financeAssetSvc *application.FinanceAssetCoreService, inventoryFinanceSvc *application.InventoryFinanceCoreService, retailFinanceSvc *application.RetailFinanceCoreService, treasurySvc *application.TreasuryCoreService, productionCostingSvc *application.ProductionCostingCoreService, policySvc *policy.Service, fieldSecurity *securityfields.Service) {
	...
	registerUIDashboardRoutes(mux, ident, analyticsSvc, modules)
	...
	registerUICRMRoutes(mux, ident, crmSvc)
	...
	registerUIFinanceRoutes(mux, ident, financeSvc, reconciliationSvc, periodEndSvc, manualJournalSvc, collectionsSvc, financeAssetSvc, inventoryFinanceSvc, retailFinanceSvc, treasurySvc, productionCostingSvc)
	_ = fulfillmentSvc
	_ = productionSvc
	_ = recallSvc
}

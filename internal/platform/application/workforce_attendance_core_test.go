...
func registerWorkforceAttendanceTestModels(t *testing.T, models *model.Service) {
	...
	defs := []model.Definition{
		...
		{Key: "leave_request", DisplayName: "Leave Request", DefaultSort: "start_date", Fields: []model.FieldDefinition{{Key: "employee_id", Type: "string"}, {Key: "absence_code_id", Type: "string"}, {Key: "start_date", Type: "string"}, {Key: "end_date", Type: "string"}, {Key: "requested_days", Type: "number"}, {Key: "requested_hours", Type: "number"}, {Key: "count_basis", Type: "string"}, {Key: "counted_dates_json", Type: "string"}, {Key: "counted_work_calendar_id", Type: "string"}, {Key: "counted_roster_slot_ids_json", Type: "string"}, {Key: "approval_status", Type: "string"}, {Key: "organization_id", Type: "string"}, {Key: "location_id", Type: "string"}, {Key: "status", Type: "string"}}},

...
func commercialCoreKernelPackManifest() module.Manifest {
	return module.Manifest{
		...
		Models: []model.Definition{
			...
			commercialCatalogModelDefinition(
				...
				[]model.FieldDefinition{
					...
					{Key: "name", Label: "Name", LabelI18n: localize("Name", "Nama"), Type: "string", Required: true},
					{Key: "description", Label: "Description", LabelI18n: localize("Description", "Deskripsi"), Type: "string"},
					{Key: "product_code", Label: "Product", LabelI18n: localize("Product", "Produk"), Type: "string", ConstraintRuleKeys: []string{"commercial.item.product_link"}},
					{Key: "is_variant", Label: "Variant SKU", LabelI18n: localize("Variant SKU", "SKU Varian"), Type: "bool"},
					{Key: "variant_signature", Label: "Variant Signature", LabelI18n: localize("Variant Signature", "Signature Varian"), Type: "string", ConstraintRuleKeys: []string{"commercial.item.variant_signature.unique"}},
		...
		Frontend: module.FrontendDefinition{
			Menus: append(commercialModelMenus(),
...
func ledgerColumns() []module.ColumnDefinition {
	return []module.ColumnDefinition{
		...
		{Key: "journal_source_kind", Label: "Source Kind", LabelI18n: localize("Source Kind", "Jenis Sumber"), Path: "body.payload.journal_source_kind"},
		{Key: "manual_journal_type", Label: "Journal Type", LabelI18n: localize("Journal Type", "Tipe Jurnal"), Path: "body.payload.manual_journal_type"},
		...
		{Key: "submitted_by", Label: "Submitted By", LabelI18n: localize("Submitted By", "Diajukan Oleh"), Path: "body.payload.submitted_by"},
		{Key: "approved_by", Label: "Approved By", LabelI18n: localize("Approved By", "Disetujui Oleh"), Path: "body.payload.approved_by"},
		{Key: "total_amount", Label: "Total", LabelI18n: localize("Total", "Total"), Path: "body.payload.total_amount"},
		{Key: "status", Label: "Status", LabelI18n: localize("Status", "Status"), Path: "header.status"},
	}
}
...
func ledgerSections() []module.SectionDefinition {
	return []module.SectionDefinition{
		{Key: "summary", Title: "Posting Summary", TitleI18n: localize("Posting Summary", "Ringkasan Posting"), Fields: []module.FieldDefinition{
			...
			{Key: "manual_journal_type", Label: "Manual Journal Type", LabelI18n: localize("Manual Journal Type", "Tipe Jurnal Manual"), Path: "body.payload.manual_journal_type", Type: "string"},
			{Key: "requires_approval", Label: "Requires Approval", LabelI18n: localize("Requires Approval", "Perlu Persetujuan"), Path: "body.payload.requires_approval", Type: "bool"},
			...
			{Key: "correction_of_posting_id", Label: "Correction Of Posting ID", LabelI18n: localize("Correction Of Posting ID", "ID Posting Koreksi"), Path: "body.payload.correction_of_posting_id", Type: "string"},
			{Key: "corrected_by_posting_id", Label: "Corrected By Posting ID", LabelI18n: localize("Corrected By Posting ID", "ID Posting Pengoreksi"), Path: "body.payload.corrected_by_posting_id", Type: "string"},
			{Key: "supporting_reference", Label: "Supporting Reference", LabelI18n: localize("Supporting Reference", "Referensi Pendukung"), Path: "body.payload.supporting_reference", Type: "string"},
			{Key: "submission_note", Label: "Submission Note", LabelI18n: localize("Submission Note", "Catatan Pengajuan"), Path: "body.payload.submission_note", Type: "string"},
			{Key: "approval_note", Label: "Approval Note", LabelI18n: localize("Approval Note", "Catatan Persetujuan"), Path: "body.payload.approval_note", Type: "string"},
			{Key: "submitted_by", Label: "Submitted By", LabelI18n: localize("Submitted By", "Diajukan Oleh"), Path: "body.payload.submitted_by", Type: "string"},
			{Key: "submitted_at", Label: "Submitted At", LabelI18n: localize("Submitted At", "Diajukan Pada"), Path: "body.payload.submitted_at", Type: "string"},
			{Key: "approved_by", Label: "Approved By", LabelI18n: localize("Approved By", "Disetujui Oleh"), Path: "body.payload.approved_by", Type: "string"},
			{Key: "approved_at", Label: "Approved At", LabelI18n: localize("Approved At", "Disetujui Pada"), Path: "body.payload.approved_at", Type: "string"},
			{Key: "total_amount", Label: "Total", LabelI18n: localize("Total", "Total"), Path: "body.payload.total_amount", Type: "number"},
...
func ledgerFormSections() []module.SectionDefinition {
	return []module.SectionDefinition{
		{Key: "posting", Title: "Posting Details", TitleI18n: localize("Posting Details", "Detail Posting"), Fields: []module.FieldDefinition{
			...
			{Key: "manual_journal_type", Label: "Manual Journal Type", LabelI18n: localize("Manual Journal Type", "Tipe Jurnal Manual"), Path: "body.payload.manual_journal_type", Type: "string", Widget: "select", Options: []string{"adjusting", "opening_balance", "reclass", "correction", "other"}},
			{Key: "requires_approval", Label: "Requires Approval", LabelI18n: localize("Requires Approval", "Perlu Persetujuan"), Path: "body.payload.requires_approval", Type: "bool"},
			...
			{Key: "correction_of_posting_id", Label: "Correction Of Posting ID", LabelI18n: localize("Correction Of Posting ID", "ID Posting Koreksi"), Path: "body.payload.correction_of_posting_id", Type: "string", Widget: "text"},
			{Key: "corrected_by_posting_id", Label: "Corrected By Posting ID", LabelI18n: localize("Corrected By Posting ID", "ID Posting Pengoreksi"), Path: "body.payload.corrected_by_posting_id", Type: "string", Widget: "text", ReadOnly: true},
			{Key: "supporting_reference", Label: "Supporting Reference", LabelI18n: localize("Supporting Reference", "Referensi Pendukung"), Path: "body.payload.supporting_reference", Type: "string", Widget: "text"},
			{Key: "submission_note", Label: "Submission Note", LabelI18n: localize("Submission Note", "Catatan Pengajuan"), Path: "body.payload.submission_note", Type: "string", Widget: "textarea"},
			{Key: "approval_note", Label: "Approval Note", LabelI18n: localize("Approval Note", "Catatan Persetujuan"), Path: "body.payload.approval_note", Type: "string", Widget: "textarea"},
			{Key: "submitted_by", Label: "Submitted By", LabelI18n: localize("Submitted By", "Diajukan Oleh"), Path: "body.payload.submitted_by", Type: "string", Widget: "text", ReadOnly: true},
			{Key: "submitted_at", Label: "Submitted At", LabelI18n: localize("Submitted At", "Diajukan Pada"), Path: "body.payload.submitted_at", Type: "string", Widget: "text", ReadOnly: true},
			{Key: "approved_by", Label: "Approved By", LabelI18n: localize("Approved By", "Disetujui Oleh"), Path: "body.payload.approved_by", Type: "string", Widget: "text", ReadOnly: true},
			{Key: "approved_at", Label: "Approved At", LabelI18n: localize("Approved At", "Disetujui Pada"), Path: "body.payload.approved_at", Type: "string", Widget: "text", ReadOnly: true},
			{Key: "total_amount", Label: "Total", LabelI18n: localize("Total", "Total"), Path: "body.payload.total_amount", Type: "number"},

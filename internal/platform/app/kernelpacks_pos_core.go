	...
	return module.Manifest{
		...
		Models: []model.Definition{
			posModelDefinition("pos_store", "POS Store", "pos_store", []model.FieldDefinition{
				...
				{Key: "receipt_variants", Label: "Receipt Variants", LabelI18n: localize("Receipt Variants", "Varian Struk"), Type: "string"},
				{Key: "receipt_brand_name", Label: "Receipt Brand Name", LabelI18n: localize("Receipt Brand Name", "Nama Brand Struk"), Type: "string"},
				{Key: "receipt_header_text", Label: "Receipt Header Text", LabelI18n: localize("Receipt Header Text", "Teks Header Struk"), Type: "string"},
				{Key: "receipt_footer_text", Label: "Receipt Footer Text", LabelI18n: localize("Receipt Footer Text", "Teks Footer Struk"), Type: "string"},
				{Key: "receipt_support_text", Label: "Receipt Support Text", LabelI18n: localize("Receipt Support Text", "Teks Bantuan Struk"), Type: "string"},
				{Key: "receipt_service_text", Label: "Receipt Service Text", LabelI18n: localize("Receipt Service Text", "Teks Layanan Struk"), Type: "string"},
				{Key: "receipt_merchant_note", Label: "Receipt Merchant Note", LabelI18n: localize("Receipt Merchant Note", "Catatan Merchant Struk"), Type: "string"},
				{Key: "receipt_show_qr", Label: "Receipt Show QR", LabelI18n: localize("Receipt Show QR", "Tampilkan QR di Struk"), Type: "bool", DefaultValue: "true"},
...
func posStoreDetailView() module.ViewDefinition {
	return commercialModelDetailView("pos.stores.detail", "POS Store Detail", "pos_store", []module.FieldDefinition{
		...
		{Key: "receipt_variants", Label: "Receipt Variants", LabelI18n: localize("Receipt Variants", "Varian Struk"), Path: "values.receipt_variants", Type: "string"},
		{Key: "receipt_brand_name", Label: "Receipt Brand Name", LabelI18n: localize("Receipt Brand Name", "Nama Brand Struk"), Path: "values.receipt_brand_name", Type: "string"},
		{Key: "receipt_header_text", Label: "Receipt Header Text", LabelI18n: localize("Receipt Header Text", "Teks Header Struk"), Path: "values.receipt_header_text", Type: "string"},
		{Key: "receipt_footer_text", Label: "Receipt Footer Text", LabelI18n: localize("Receipt Footer Text", "Teks Footer Struk"), Path: "values.receipt_footer_text", Type: "string"},
		{Key: "receipt_support_text", Label: "Receipt Support Text", LabelI18n: localize("Receipt Support Text", "Teks Bantuan Struk"), Path: "values.receipt_support_text", Type: "string"},
		{Key: "receipt_service_text", Label: "Receipt Service Text", LabelI18n: localize("Receipt Service Text", "Teks Layanan Struk"), Path: "values.receipt_service_text", Type: "string"},
		{Key: "receipt_merchant_note", Label: "Receipt Merchant Note", LabelI18n: localize("Receipt Merchant Note", "Catatan Merchant Struk"), Path: "values.receipt_merchant_note", Type: "string"},
		{Key: "receipt_show_qr", Label: "Receipt Show QR", LabelI18n: localize("Receipt Show QR", "Tampilkan QR di Struk"), Path: "values.receipt_show_qr", Type: "bool"},
...
func posStoreFormView() module.ViewDefinition {
	return commercialModelFormView("pos.stores.form", "POS Store Form", "pos_store", []module.FieldDefinition{
		...
		{Key: "receipt_variants", Label: "Receipt Variants", LabelI18n: localize("Receipt Variants", "Varian Struk"), Path: "values.receipt_variants", Type: "string", Widget: "text"},
		{Key: "receipt_brand_name", Label: "Receipt Brand Name", LabelI18n: localize("Receipt Brand Name", "Nama Brand Struk"), Path: "values.receipt_brand_name", Type: "string", Widget: "text"},
		{Key: "receipt_header_text", Label: "Receipt Header Text", LabelI18n: localize("Receipt Header Text", "Teks Header Struk"), Path: "values.receipt_header_text", Type: "string", Widget: "textarea"},
		{Key: "receipt_footer_text", Label: "Receipt Footer Text", LabelI18n: localize("Receipt Footer Text", "Teks Footer Struk"), Path: "values.receipt_footer_text", Type: "string", Widget: "textarea"},
		{Key: "receipt_support_text", Label: "Receipt Support Text", LabelI18n: localize("Receipt Support Text", "Teks Bantuan Struk"), Path: "values.receipt_support_text", Type: "string", Widget: "textarea"},
		{Key: "receipt_service_text", Label: "Receipt Service Text", LabelI18n: localize("Receipt Service Text", "Teks Layanan Struk"), Path: "values.receipt_service_text", Type: "string", Widget: "textarea"},
		{Key: "receipt_merchant_note", Label: "Receipt Merchant Note", LabelI18n: localize("Receipt Merchant Note", "Catatan Merchant Struk"), Path: "values.receipt_merchant_note", Type: "string", Widget: "textarea"},
		{Key: "receipt_show_qr", Label: "Receipt Show QR", LabelI18n: localize("Receipt Show QR", "Tampilkan QR di Struk"), Path: "values.receipt_show_qr", Type: "string", Widget: "select", Options: []string{"true", "false"}},
...
func posRegisterDetailView() module.ViewDefinition {
	return commercialModelDetailView("pos.registers.detail", "POS Register Detail", "pos_register", []module.FieldDefinition{
		...
		{Key: "receipt_template_key", Label: "Receipt Template", LabelI18n: localize("Receipt Template", "Template Struk"), Path: "values.receipt_template_key", Type: "string"},
		{Key: "receipt_variants", Label: "Receipt Variants", LabelI18n: localize("Receipt Variants", "Varian Struk"), Path: "values.receipt_variants", Type: "string"},
		{Key: "receipt_brand_name", Label: "Receipt Brand Name", LabelI18n: localize("Receipt Brand Name", "Nama Brand Struk"), Path: "values.receipt_brand_name", Type: "string"},
		{Key: "receipt_header_text", Label: "Receipt Header Text", LabelI18n: localize("Receipt Header Text", "Teks Header Struk"), Path: "values.receipt_header_text", Type: "string"},
		{Key: "receipt_footer_text", Label: "Receipt Footer Text", LabelI18n: localize("Receipt Footer Text", "Teks Footer Struk"), Path: "values.receipt_footer_text", Type: "string"},

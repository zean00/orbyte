...
func crmMCPTools() []module.MCPToolDefinition {
	return []module.MCPToolDefinition{
		...
		{Key: "crm.customer.summary", Title: "Get CRM Customer Summary", TitleI18n: localize("Get CRM Customer Summary", "Ambil Ringkasan Pelanggan CRM"), Description: "Load a CRM customer 360 summary with service tickets, customer health, sales opportunities, and profile data.", DescriptionI18n: localize("Load a CRM customer 360 summary with service tickets, customer health, sales opportunities, and profile data.", "Muat ringkasan customer 360 CRM dengan tiket layanan, kesehatan pelanggan, peluang penjualan, dan data profil."), Operation: "crm.customer.summary", RequiredPermissions: crmCustomer360Permissions, InputSchema: crmPartyLookupSchema(), Contract: module.MCPContractMetadata{BusinessDomains: []string{"crm", "service", "sales"}}},
		{Key: "crm.customer.timeline", Title: "Get CRM Customer Timeline", TitleI18n: localize("Get CRM Customer Timeline", "Ambil Timeline Pelanggan CRM"), Description: "Load CRM activities, service ticket history, and sales follow-up for one customer.", DescriptionI18n: localize("Load CRM activities, service ticket history, and sales follow-up for one customer.", "Muat aktivitas CRM, riwayat tiket layanan, dan tindak lanjut penjualan untuk satu pelanggan."), Operation: "crm.customer.timeline", RequiredPermissions: crmCustomer360Permissions, InputSchema: crmPartyLookupSchema(), Contract: module.MCPContractMetadata{BusinessDomains: []string{"crm", "service", "sales"}}},

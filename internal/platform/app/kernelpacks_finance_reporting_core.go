	...
	return module.Manifest{
		...
		Frontend: module.FrontendDefinition{
			Menus: []module.MenuDefinition{
				...
				{Key: "finance.ar_aging", Label: "AR Aging", LabelI18n: localize("AR Aging", "Umur Piutang"), ActionKey: "finance.ar_aging", Order: 94, RequiredPermissions: []string{"finance.read", "document.read"}},
				{Key: "finance.ap_aging", Label: "AP Aging", LabelI18n: localize("AP Aging", "Umur Utang"), ActionKey: "finance.ap_aging", Order: 95, RequiredPermissions: []string{"finance.read", "document.read"}},
				{Key: "finance.ar_reconciliation", Label: "AR Reconciliation", LabelI18n: localize("AR Reconciliation", "Rekonsiliasi Piutang"), ActionKey: "finance.ar_reconciliation", Order: 96, RequiredPermissions: []string{"finance.read", "document.read"}},
				{Key: "finance.ap_reconciliation", Label: "AP Reconciliation", LabelI18n: localize("AP Reconciliation", "Rekonsiliasi Utang"), ActionKey: "finance.ap_reconciliation", Order: 97, RequiredPermissions: []string{"finance.read", "document.read"}},
				{Key: "finance.journal_ledger", Label: "Journal Ledger", LabelI18n: localize("Journal Ledger", "Buku Jurnal"), ActionKey: "finance.journal_ledger", Order: 98, RequiredPermissions: []string{"finance.read", "document.read"}},
			},

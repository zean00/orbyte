	...
	return module.Manifest{
		...
		Models: []model.Definition{
			...
			attendanceModelDefinition("leave_request", "Leave Request", []model.FieldDefinition{
				...
				{Key: "balance_account_id", Label: "Balance Account", LabelI18n: localize("Balance Account", "Akun Saldo"), Type: "string"},
				{Key: "start_date", Label: "Start Date", LabelI18n: localize("Start Date", "Tanggal Mulai"), Type: "string", Required: true},
				{Key: "end_date", Label: "End Date", LabelI18n: localize("End Date", "Tanggal Selesai"), Type: "string", Required: true},
				{Key: "request_unit", Label: "Request Unit", LabelI18n: localize("Request Unit", "Unit Permintaan"), Type: "string", DefaultValue: "day"},
				{Key: "requested_days", Label: "Requested Days", LabelI18n: localize("Requested Days", "Hari Diminta"), Type: "number"},
				{Key: "half_day_session", Label: "Half Day Session", LabelI18n: localize("Half Day Session", "Sesi Setengah Hari"), Type: "string"},
				{Key: "requested_hours", Label: "Requested Hours", LabelI18n: localize("Requested Hours", "Jam Diminta"), Type: "number"},
				{Key: "count_basis", Label: "Count Basis", LabelI18n: localize("Count Basis", "Basis Perhitungan"), Type: "string"},
				{Key: "counted_dates_json", Label: "Counted Dates JSON", LabelI18n: localize("Counted Dates JSON", "JSON Tanggal Dihitung"), Type: "string"},
				{Key: "counted_work_calendar_id", Label: "Counted Work Calendar", LabelI18n: localize("Counted Work Calendar", "Kalender Kerja Terhitung"), Type: "string"},
				{Key: "counted_roster_slot_ids_json", Label: "Counted Roster Slot IDs JSON", LabelI18n: localize("Counted Roster Slot IDs JSON", "JSON ID Slot Roster Dihitung"), Type: "string"},
				{Key: "request_source", Label: "Request Source", LabelI18n: localize("Request Source", "Sumber Permintaan"), Type: "string"},
				{Key: "self_service_actor_user_id", Label: "Self-Service Actor User", LabelI18n: localize("Self-Service Actor User", "Pengguna Layanan Mandiri"), Type: "string"},
...
func attendanceDayFields(form bool) []module.FieldDefinition {
	return []module.FieldDefinition{
		...
		{Key: "attendance_status", Label: "Attendance Status", LabelI18n: localize("Attendance Status", "Status Kehadiran"), Path: "values.attendance_status", Type: "string", Widget: widgetForForm(form, "select"), Options: []string{"present", "absent", "late", "leave", "overtime", "incomplete"}},
...
func attendanceLeaveFields(form bool) []module.FieldDefinition {
	return []module.FieldDefinition{
		...
		{Key: "leave_policy_id", Label: "Leave Policy", LabelI18n: localize("Leave Policy", "Kebijakan Cuti"), Path: "values.leave_policy_id", Type: "string", Widget: widgetForForm(form, "select")},
		{Key: "employee_leave_profile_id", Label: "Leave Profile", LabelI18n: localize("Leave Profile", "Profil Cuti"), Path: "values.employee_leave_profile_id", Type: "string", Widget: widgetForForm(form, "select")},
		{Key: "balance_account_id", Label: "Balance Account", LabelI18n: localize("Balance Account", "Akun Saldo"), Path: "values.balance_account_id", Type: "string", Widget: widgetForForm(form, "select")},
		{Key: "start_date", Label: "Start Date", LabelI18n: localize("Start Date", "Tanggal Mulai"), Path: "values.start_date", Type: "string", Widget: widgetForForm(form, "text"), Required: true},
		{Key: "end_date", Label: "End Date", LabelI18n: localize("End Date", "Tanggal Selesai"), Path: "values.end_date", Type: "string", Widget: widgetForForm(form, "text"), Required: true},
		{Key: "request_unit", Label: "Request Unit", LabelI18n: localize("Request Unit", "Unit Permintaan"), Path: "values.request_unit", Type: "string", Widget: widgetForForm(form, "select"), Options: []string{"day", "half_day"}},
		{Key: "requested_days", Label: "Requested Days", LabelI18n: localize("Requested Days", "Hari Diminta"), Path: "values.requested_days", Type: "number", Widget: widgetForForm(form, "text")},
		{Key: "half_day_session", Label: "Half Day Session", LabelI18n: localize("Half Day Session", "Sesi Setengah Hari"), Path: "values.half_day_session", Type: "string", Widget: widgetForForm(form, "select"), Options: []string{"morning", "afternoon"}},
		...
		{Key: "count_basis", Label: "Count Basis", LabelI18n: localize("Count Basis", "Basis Perhitungan"), Path: "values.count_basis", Type: "string", Widget: widgetForForm(form, "text")},
		{Key: "counted_dates_json", Label: "Counted Dates JSON", LabelI18n: localize("Counted Dates JSON", "JSON Tanggal Dihitung"), Path: "values.counted_dates_json", Type: "string", Widget: widgetForForm(form, "textarea")},
		{Key: "counted_work_calendar_id", Label: "Counted Work Calendar", LabelI18n: localize("Counted Work Calendar", "Kalender Kerja Terhitung"), Path: "values.counted_work_calendar_id", Type: "string", Widget: widgetForForm(form, "select")},
		{Key: "counted_roster_slot_ids_json", Label: "Counted Roster Slot IDs JSON", LabelI18n: localize("Counted Roster Slot IDs JSON", "JSON ID Slot Roster Dihitung"), Path: "values.counted_roster_slot_ids_json", Type: "string", Widget: widgetForForm(form, "textarea")},
		{Key: "request_source", Label: "Request Source", LabelI18n: localize("Request Source", "Sumber Permintaan"), Path: "values.request_source", Type: "string", Widget: widgetForForm(form, "text")},
		{Key: "self_service_actor_user_id", Label: "Self-Service Actor User", LabelI18n: localize("Self-Service Actor User", "Pengguna Layanan Mandiri"), Path: "values.self_service_actor_user_id", Type: "string", Widget: widgetForForm(form, "text")},
		{Key: "approval_status", Label: "Approval Status", LabelI18n: localize("Approval Status", "Status Persetujuan"), Path: "values.approval_status", Type: "string", Widget: widgetForForm(form, "select"), Options: []string{"draft", "submitted", "approved", "rejected", "cancelled"}},
		{Key: "approved_days", Label: "Approved Days", LabelI18n: localize("Approved Days", "Hari Disetujui"), Path: "values.approved_days", Type: "number", Widget: widgetForForm(form, "text")},
		...
		{Key: "reservation_entry_ids_json", Label: "Reservation Entries JSON", LabelI18n: localize("Reservation Entries JSON", "JSON Entri Reservasi"), Path: "values.reservation_entry_ids_json", Type: "string", Widget: widgetForForm(form, "textarea")},
		{Key: "consumption_entry_ids_json", Label: "Consumption Entries JSON", LabelI18n: localize("Consumption Entries JSON", "JSON Entri Konsumsi"), Path: "values.consumption_entry_ids_json", Type: "string", Widget: widgetForForm(form, "textarea")},
		{Key: "notes", Label: "Notes", LabelI18n: localize("Notes", "Catatan"), Path: "values.notes", Type: "string", Widget: widgetForForm(form, "textarea")},
		{Key: "status", Label: "Status", LabelI18n: localize("Status", "Status"), Path: "values.status", Type: "string", Widget: widgetForForm(form, "select"), Options: []string{"active", "inactive"}},
	}
}
